...
export default function Header() {
  return (
    <div
      className="fixed-top absolute-top position-sticky container justify-content-between align-items-center "
      ...
      <nav className="navbar navbar-expand-lg ">
        ...
        >
          ...
          >
            <Link
              href="/"
              className="nav-item nav-link m-0 p-0 text-end text-decoration-none "
            >
              English
            </Link>
