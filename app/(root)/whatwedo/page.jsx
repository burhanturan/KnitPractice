  ...
  >
   ...
   <div style={{ maxWidth: "630px" }}>
          ...
          <p>
            ...
            <div className="picture" style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
           <Image width={610} height={550} src="/whatwedoImg.png" alt="" style={{ display: "inline-block", marginLeft: "auto", marginRight: "auto" }} />
          </div>
            </div>
      ...
      >
        <div className="picture" style={{ maxWidth: "600px" }}>
          <Image className="picture" width={610} height={550} src="/whatwedoSecondImg.png" alt="" />
        </div>

        <div style={{ maxWidth: "630px" }}>
          <h1 style={style2}>Our Mission</h1>
          <h4 className= "fw-bold" style={{fontSize: "20px"}}>"To weave a digital future where every connection counts"</h4>
          <p style={{fontSize: "18px"}}>
        In a world brimming with potential, our mission is to empower every individual 
        and business with cutting-edge web solutions. From fostering collaboration
         to driving discovery, we're here to help communities innovate and thrive.
          </p>
          <h1 style={{ ...style2, marginTop: "45px" }}>Our Products</h1>
          <p style={{fontSize: "18px"}}>
          Our suite of products embodies our ethos of agility and user-centric design.
           From sleek, intuitive web applications to comprehensive digital solutions for 
           small businesses, we tailor technology to fit your needs. Our goal? To transform 
           your digital landscape, making technology work for you.
          </p>
          <div style={{justifyContent: "center", marginTop: "250px" }}>
  <Link
    href="/"
